...
async def generate_post(topic: str, post_type: str = "announcement", platform: str = "telegram") -> str:
    """
    Генерация поста для /create_post.
...
async def adapt_for_platform(content: str, target_platform: str = "vk") -> str:
    """
    Адаптация существующего текста под VK.
    """
